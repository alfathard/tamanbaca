				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							<form method="post" action="<?= base_url('bacaan/edit/update/'. $bacaan->id)?>" enctype="multipart/form-data">
								<div class="card-body">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>Judul</label>
												<input name="judul" type="text" value="<?= $bacaan->judul ?>" class="form-control" id="email" placeholder="Masukan Judul" required>
											</div>
											<div class="form-group">
												<label>Foto</label>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="kategori" class="form-control">
													<option value="sejarah" <?php if ($bacaan->kategori == 'sejarah') echo 'selected'?>>Sejarah</option>
													<option value="dongeng" <?php if ($bacaan->kategori == 'dongeng') echo 'selected'?>>Dongeng</option>
													<option value="agama" <?php if ($bacaan->kategori == 'agama') echo 'selected'?>>Agama</option>
													<option value="lirik" <?php if ($bacaan->kategori == 'lirik') echo 'selected'?>>Lirik</option>
												</select>
											</div>
										</div>
										<div class="col-md-12">
